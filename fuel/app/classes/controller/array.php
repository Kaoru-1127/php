...
class Controller_Array extends Controller{
	...
	public function action_arraysample12(){
		$view = View::forge('array/array_sample12');
		return Response::forge($view);
	}
	public function action_arraysample13(){
		$view = View::forge('array/array_sample13');
		return Response::forge($view);
	}
	public function action_arraysample14(){
		$view = View::forge('array/array_sample14');
		return Response::forge($view);
	}
